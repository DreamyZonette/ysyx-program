...
void isa_reg_display() {
	svSetScope(svGetScopeFromName("OP.ysyx_25020042.gpr_u"));
	int i;
	int count = 0;
	...
	svSetScope(svGetScopeFromName("OP.ysyx_25020042.csr_u"));
	...
	printf("\n");
	svSetScope(svGetScopeFromName("OP.ysyx_25020042.IFU_u"));
}
