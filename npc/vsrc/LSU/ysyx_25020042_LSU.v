...
// 记得修改回来
wire [31:0] shifted_rdata = (lsu_araddr >= 32'h3000_0000 && lsu_araddr < 32'h4000_0000 || lsu_araddr >= 32'h8000_0000 && lsu_araddr < 32'h8400_0000) ? lsu_rdata : lsu_rdata >> (lsu_araddr[1:0] * 8);
