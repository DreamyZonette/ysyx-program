...
VL_INLINE_OPT void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT__op_ins = ((0x13U == (0x7fU & vlSelf->inst))
                                 ? ((0U == (7U & (vlSelf->inst 
                                                  >> 0xcU)))
                                     ? 1U : ((2U == 
                                              (7U & 
...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->reset) {
        ...
        if ((0x825U >= (0xfffU & ((IData)(0x801U) + vlSelf->o_pc)))) {
            ...
            __Vdlyvdim0__top__DOT__ram__DOT__ram_mem__v0 
                = (0xfffU & ((IData)(0x801U) + vlSelf->o_pc));
        }
        ...
        __Vdly__o_pc = ((IData)(4U) + vlSelf->o_pc);
        if (((0U != (0x1fU & (vlSelf->inst >> 7U))) 
             & (((IData)(1U) << (0x1fU & (vlSelf->inst 
                                          >> 7U))) 
                >> 0x1fU))) {
