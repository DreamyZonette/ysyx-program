...
void Valu___024root___eval_triggers__act(Valu___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.at(0U) = ((IData)(vlSelf->pc__02Eclk) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__pc__02Eclk)));
    vlSelf->__VactTriggered.at(1U) = ((IData)(vlSelf->ram__02Eclk) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__ram__02Eclk)));
    vlSelf->__VactTriggered.at(2U) = ((IData)(vlSelf->gpr__02Eclk) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__gpr__02Eclk)));
