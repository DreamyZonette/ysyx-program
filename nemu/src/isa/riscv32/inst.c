...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 001 ????? 11100 11", csrrw  , I, uint16_t caddr = imm & 0xfff; csr(caddr) = src1; R(rd) = csr(caddr); printf("0x%08x\n", csr(caddr));); // NEW
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , I, s->dnpc = isa_raise_intr(6, s->pc));// 数据测试用
