...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("??????? ????? ????? 011 ????? 11100 11", csrrw  , I, uint16_t caddr = imm & 0xfff; csr(caddr) = src1; R(rd) = csr(caddr)); // NEW
  INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall  , I, R(rd) = src1 | imm);
